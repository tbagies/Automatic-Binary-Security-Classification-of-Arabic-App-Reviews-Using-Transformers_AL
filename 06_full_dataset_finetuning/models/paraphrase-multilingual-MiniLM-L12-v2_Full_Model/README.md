...
print(similarities)
# tensor([[ 1.0000, -0.4594, -0.5176],
#         [-0.4594,  1.0000,  0.9392],
#         [-0.5176,  0.9392,  1.0000]])
```
<!--
...
* Approximate statistics based on the first 100 samples:
  ...
  | type     | string                                                                             | int                                             |
  | modality | text                                                                               |                                                 |
  | details  | <ul><li>min: 3 tokens</li><li>mean: 51.31 tokens</li><li>max: 128 tokens</li></ul> | <ul><li>0: ~46.15%</li><li>1: ~53.85%</li></ul> |
* Samples:
  | sentence                                                             | label          |
  |:---------------------------------------------------------------------|:---------------|
